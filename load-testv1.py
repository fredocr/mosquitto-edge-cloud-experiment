# To confirm, broker must suscribe to the 3 sensors, first 2 sensors have priority one and second sensor has priority 2
# mosquitto_sub -h localhost -t "sensor1" -q 1 -t "sensor2" -q 1 -t "sensor3" -q 2




#Added # Function to show a summary of the data transferred





#To modulate  the amount of data modify the number of devices.
#11k equals aprox 10gb over 3 hrs
...
while time.time() - start_time < run_time:
    for i in range(num_devices * 100):
        for topic in topics:
